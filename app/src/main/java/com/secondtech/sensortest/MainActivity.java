...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((PlotView)findViewById(R.id.plotViewX)).setData(this, plotViewModel.getAccelerationTimeSeries(), plotViewModel.getVelocityTimeSeries(), plotViewModel.getPositionTimeSeries(), 0);
        ((PlotView)findViewById(R.id.plotViewY)).setData(this, plotViewModel.getAccelerationTimeSeries(), plotViewModel.getVelocityTimeSeries(), plotViewModel.getPositionTimeSeries(), 1);
        ((PlotView)findViewById(R.id.plotViewZ)).setData(this, plotViewModel.getAccelerationTimeSeries(), plotViewModel.getVelocityTimeSeries(), plotViewModel.getPositionTimeSeries(), 2);
    }
